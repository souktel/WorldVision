...
$req_msg = "";
$req_ps = "37190"; //Palestine
$req_intl = "46737494560"; //Clickatell International
$req_sender_id = "";
$req_senderx = "";
$command_array = array();
...
function send_sms($sender, $sys_id, $recievers_a, $sms_body, $reason, $sendby2) {
    ...
    for($reci=0; $reci < $nor; $reci++) {
        ...
        mysql_query("INSERT INTO tbl_sms_receivers VALUES($msgidpk, '$rec', '$sendby2', '', NULL, '')", $sms_dbid);
    }
