    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function sendSMS(str_sc, str_from, str_text)
            {
                ...
                var url="http://<?php echo $_SERVER['HTTP_HOST'];?>/modules/sms/index.php?tester_agent=yes1&sc="+str_sc+"&from="+str_from+"&text="+str_text;
                    ...
                    <td>
                        <div align="left">
                            <table border="0" width="100%" cellspacing="6" cellpadding="6" style="border-collapse: collapse">
                                ...
                                <tr>
                                    <td>
                                    <input id="sc" type="text" name="sc" size="30" value="249917260017"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                    <input id="from" type="text" name="from" size="30" value="972599768669"></td>
                                </tr>
                                <tr>
