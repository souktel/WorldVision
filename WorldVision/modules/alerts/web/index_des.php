...
//Pages
$query = "SELECT message_id, title, body, creation_date FROM tbl_alerts_message msg WHERE user_id = $param_session_user_user_id AND status IN(0,9) AND message_id NOT IN (SELECT message_id FROM tbl_alerts_message_log WHERE message_id = msg.message_id) AND is_scheduled = 0 ORDER BY creation_date DESC";
...
<table border="0" width="680" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
    ...
    <tr>
	    ...
	    <font face="Trebuchet MS" size="2">
                    Please Note: Once alerts are sent they will automatically move to the Sent Alerts page.
            </font>
	</td>
    </tr>
    <tr>
