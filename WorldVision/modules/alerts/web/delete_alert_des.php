...
?>
<?php
$alert_id = string_wslashes($_GET['aid']);
...
<form name="skform" method="POST" action="<?php echo $file_name."?act=1";?>">
    ...
    <table border="0" width="100%" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
        <tr>
            ...
            <span lang="en-us">Are you sure you want to delete this alert <?php echo $msg;?>.</span></font></td>
        </tr>
        <tr>
            <td width="3%">&nbsp;</td>
            <td width="48%" colspan="2">
		<input type="submit" value="Yes(Delete Alert)" name="submit"/>
