...
//File Name
$file_name = $apath."modules/system/def_modules.php";
...
$module_prefix = "System"; //Module Prefix

//Design Page
$design_page = "modules/system/def_modules_des.php";

//Submit Page
$submit_page = "modules/system/def_modules_sub.php";

//Functions List
$function_list_path = "modules/system/index_fun.php"; //Path of file which contains the function list ["" if no list]
$function_list_title = "Utilities"; //Title of the function box [e.g. "Functions"]
$function_cur_index = 5; //The index of the function we are in [-1 if no function]
