...
$module_prefix = "MiniSurvey"; //Module Prefix

//Design Page
$design_page = "modules/ms/web/index_des.php";

//Submit Page
$submit_page = "";

//Functions List
$function_list_path = "modules/ms/web/index_fun.php"; //Path of file which contains the function list ["" if no list]
