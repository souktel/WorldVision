...
//File Name
$file_name = $apath."modules/surveys/web/create_survey.php";
...
//Design Page
$design_page = "modules/surveys/web/create_survey_des.php";

//Submit Page
$submit_page = "modules/surveys/web/create_survey_sub.php";
