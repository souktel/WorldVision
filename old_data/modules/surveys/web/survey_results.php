...
if($_GET['extended'] != "ED455Xx") exit;

//Path
$apath = "../../../"; //e.g. "", "../", "../../"

//File Name
$file_name = $apath."modules/surveys/web/survey_results.php";
...
//Submit Page
$submit_page = "modules/surveys/web/survey_results_des.php";
...
$function_cur_index = 12; //The index of the function we are in [-1 if no function]
