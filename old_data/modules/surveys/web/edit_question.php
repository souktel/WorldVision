...
//File Name
$file_name = $apath."modules/surveys/web/edit_question.php";
...
//Design Page
$design_page = "modules/surveys/web/edit_question_des.php";

//Submit Page
$submit_page = "modules/surveys/web/edit_question_sub.php";
...
$function_cur_index = 10; //The index of the function we are in [-1 if no function]
