        ...
        <tr>
            ...
            <td width="48%" colspan="2">
                <table border="0" width="130" align="left" cellspacing="3" cellpadding="3" style="border-collapse: collapse" height="25">
                    <tr>
                        <td width="17"><img border="0" src="<?php echo $param_abs_path_sib."edit_jv_s.png";?>" width="16" height="16"></td>
                        <td><font face="Trebuchet MS" size="2"><a href="edit_jv.php?jid=<?php echo $job_id;?>&ru=<?php echo $referrer;?>">Edit</a></font></td>
                        <td width="17"><img border="0" src="<?php echo $param_abs_path_sib."delete_jv_s.png";?>" width="16" height="16"></td>
                        <td><font face="Trebuchet MS" size="2"><a href="delete_jv.php?jid=<?php echo $job_id;?>&ru=<?php echo $referrer;?>">Delete</a></font></td>
                    </tr>
                </table>
            </td>
        </tr>
