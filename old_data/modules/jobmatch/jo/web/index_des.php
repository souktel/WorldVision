...
//Pages
$query = "SELECT job_id, vacancy_title, reference_code, status, addition_date FROM tbl_jo_job_vacancy WHERE sys_id = $param_session_sys_id AND user_id = $param_session_user_user_id  ORDER BY addition_date DESC";
    ...
    <tr>
        ...
        <td width="130"><table border="0" width="80" align="left" cellspacing="3" cellpadding="3" style="border-collapse: collapse" height="25">
                <tr>
                    ...
                    <td><font face="Trebuchet MS" size="2"><a href="edit_jv.php?jid=<?php echo $rs_job_id;?>"><img title="Edit Job Vacancy" border="0" src="<?php echo $param_abs_path_sib."edit_jv_s.png";?>" width="16" height="16"></a></font></td>
                    <td><font face="Trebuchet MS" size="2"><a href="delete_jv.php?jid=<?php echo $rs_job_id;?>"><img title="Delete Job Vacancy" border="0" src="<?php echo $param_abs_path_sib."delete_jv_s.png";?>" width="16" height="16"></a></font></td>
                </tr>
        </table></td>
    </tr>
    <?php
