...
//File Name
$file_name = $apath."modules/jobmatch/jo/web/delete_jv.php";
...
//Design Page
$design_page = "modules/jobmatch/jo/web/delete_jv_des.php";

//Submit Page
$submit_page = "modules/jobmatch/jo/web/delete_jv_sub.php";
