...
<form name="mtform" method="GET" action="<?php echo $file_name;?>" onsubmit="return validatePr()">
    ...
    <table border="0" width="100%" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
        ...
        <tr>
            <td width="3%">&nbsp;</td>
            <td width="48%"><font face="Trebuchet MS" size="2"><b>Job Vacancy</b><font color="#FF0000">
            *</font></font></td>
            <td width="49%">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td width="48%">
                <?php
                $dbid = db_connect();
                $query = "SELECT reference_code, addition_date FROM tbl_jo_job_vacancy WHERE sys_id = $param_session_sys_id AND user_id = $param_session_user_user_id AND status >= 1 ORDER BY addition_date DESC";
                if($jv_rs = mysql_query($query, $dbid))
                {
                    ?>
                <select size="1" name="reference" style="width:200px;">
                    <?php
        ...
        <tr>
            ...
            <td width="49%"><font face="Trebuchet MS" size="2">Availability to Work</font></td>
        </tr>
        <tr>
            <td width="3%">&nbsp;</td>
            <td width="48%">
