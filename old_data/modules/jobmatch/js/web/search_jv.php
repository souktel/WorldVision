...
//File Name
$file_name = $apath."modules/jobmatch/js/web/search_jv.php";
...
//Design Page
$design_page = "modules/jobmatch/js/web/search_jv_des.php";

//Submit Page
$submit_page = "modules/jobmatch/js/web/search_jv_sub.php";
