...
//File Name
$file_name = $apath."modules/admin/edit_system.php";
...
//Design Page
$design_page = "modules/admin/edit_system_des.php";

//Submit Page
$submit_page = "modules/admin/edit_system_sub.php";
...
$function_cur_index = 2; //The index of the function we are in [-1 if no function]
