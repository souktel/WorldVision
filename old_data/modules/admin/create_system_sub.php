...
$url_s = trim(string_wslashes(trim($_POST['url'])));
...
if (sizeof($errors)==0)
{
    ...
    $rs_system = mysql_query("INSERT INTO tbl_sys VALUES(sys_id, '$prefix', '$prefix', '$name', '$url_s', $language, $country, $system_status, $sms_status, CURRENT_TIMESTAMP, 7200, '$other_info1', '$other_info2', api_id, api_key, 0)", $dbid);
