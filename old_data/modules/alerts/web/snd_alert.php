...
//File Name
$file_name = $apath."modules/alerts/web/snd_alert.php";
...
//Design Page
$design_page = "modules/alerts/web/snd_alert_des.php";
...
$function_cur_index = 7; //The index of the function we are in [-1 if no function]
