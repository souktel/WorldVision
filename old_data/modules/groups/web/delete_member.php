...
//File Name
$file_name = $apath."modules/groups/web/delete_member.php";
...
//Design Page
$design_page = "modules/groups/web/delete_member_des.php";

//Submit Page
$submit_page = "modules/groups/web/delete_member_sub.php";
