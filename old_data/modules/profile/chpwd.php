...
//File Name
$file_name = $apath."modules/profile/chpwd.php";
...
$module_prefix = "Profile"; //Module Prefix

//Design Page
$design_page = "modules/profile/chpwd_des.php";

//Submit Page
$submit_page = "modules/profile/chpwd_sub.php";

//Functions List
$function_list_path = "modules/profile/index_fun.php"; //Path of file which contains the function list ["" if no list]
