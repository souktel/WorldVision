...
$usertype = $param_session_user_user_type;
...
if (sizeof($errors)==0)
{
    ...
    $query = "UPDATE tbl_sys_user SET name = '$name', country = $country, city = $city, email = '$email' WHERE user_id = $user_id AND sys_id = $param_session_sys_id";
