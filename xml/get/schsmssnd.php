    ...
    while($row_select_msgs = mysql_fetch_array($rs_select_msgs)) {
        ...
        if($rs_members = mysql_query($select_members, $dbid)) {
            ...
            if($members_size > 0) {
                ...
                mysql_query("INSERT INTO tbl_sms VALUES(sms_id, $message_sys, 'Souktel', '37190', '$message_mob', 'G', '$msgId', CURRENT_TIMESTAMP, '$db_message_txt', 1, $members_size, 2, 1, 0)", $dbid);
