...
$param_header_menu[$menu_count][0] = "Reports"; //Title
$param_header_menu[$menu_count][2] = "Reports"; //Prefix
$param_header_menu[$menu_count][3] = "0"; //Valid or Not
//$param_header_menu[$menu_count][4] = "1"; //Hidden from top menu or Not
$param_header_menu[$menu_count++][1] = $param_server."/modules/report/index.php";
...
//print_r($param_session_user_modules);
