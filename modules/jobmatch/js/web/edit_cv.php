...
//File Name
$file_name = $apath."modules/jobmatch/js/web/edit_cv.php";
...
//Design Page
$design_page = "modules/jobmatch/js/web/edit_cv_des.php";

//Submit Page
$submit_page = "modules/jobmatch/js/web/edit_cv_sub.php";
