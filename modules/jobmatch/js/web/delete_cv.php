...
//File Name
$file_name = $apath."modules/jobmatch/js/web/delete_cv.php";
...
//Design Page
$design_page = "modules/jobmatch/js/web/delete_cv_des.php";

//Submit Page
$submit_page = "modules/jobmatch/js/web/delete_cv_sub.php";
