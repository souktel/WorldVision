...
<form name="skform" method="POST" action="<?php echo $file_name."?act=1";?>">
    <table border="0" width="100%" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
        ...
        <tr>
            ...
            <td width="48%"><select size="1" name="education_level" style="width:200px;">
                    ...
                    while($row1 = mysql_fetch_array($rs1))
                    {
                        $row_id = $row1[0];
                        $row_name = $row1[1];
                        echo "<option value=\"$row_id\" ".($row_id==4?"selected":"").">$row_name</option>";
                    }
                    ?>
            </select></td>
        ...
        <tr>
            ...
            <td width="49%"><select size="1" name="city" style="width:200px;">
                    ...
                    while($row4 = mysql_fetch_array($rs4))
                    {
                        $row_id = $row4[0];
                        $row_name = $row4[1];
                        echo "<option value=\"$row_id\" ".($row_id==$param_session_user_city?"selected":"").">$row_name</option>";
                    }
                    db_close($dbid);
                    ?>
            </select></td>
        ...
        <tr>
            <td width="3%">&nbsp;</td>
            <td width="48%"><font face="Trebuchet MS" size="2">Availability to Work<font color="#FF0000">
            *</font></font></td>
        ...
        <tr>
            <td width="3%">&nbsp;</td>
            <td colspan="2">
                <textarea name="other_info" cols="70" rows="6"></textarea>
            </td>
        </tr>
        <tr>
            <td width="48%" colspan="3">
                <input type="submit" value="Create Mini CV" name="submit"/>
            </td>
        </tr>
    </table>
</form>
