...
<form name="skform" method="POST" action="<?php echo $file_name."?act=1";?>">
    ...
    <table border="0" width="100%" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
        <tr>
            ...
            <span lang="en-us">Are you sure you want to delete mini cv <?php echo $msg;?>.</span></font></td>
        </tr>
        <tr>
            <td width="3%">&nbsp;</td>
            <td width="48%" colspan="2"><b><font face="Trebuchet MS" size="2"><input type="submit" value="Yes(Delete Mini CV)" name="submit"/>&nbsp;<a href="<?php echo $_GET['ru']==""?$referrer:$_GET['ru'];?>"><<&nbsp;Return to previous!</a></font></b></td>
        </tr>
    </table>
</form>
