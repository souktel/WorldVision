...
//File Name
$file_name = $apath."modules/jobmatch/js/web/create_cv.php";
...
//Design Page
$design_page = "modules/jobmatch/js/web/create_cv_des.php";

//Submit Page
$submit_page = "modules/jobmatch/js/web/create_cv_sub.php";
