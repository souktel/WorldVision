    ...
    <table border="0" width="100%" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
        ...
        <tr>
            ...
            <td width="49%">
                <select size="1" name="driving_license" style="width:200px;">
                    <option value="0" <?php echo  ($driving_license==0?"selected":"");?>>No I Don't Have</option>
                    <option value="1" <?php echo  ($driving_license==1?"selected":"");?>>Yes I Have</option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="48%" colspan="3">
                <input type="submit" value="Edit Mini CV" name="submit"/>
            </td>
        </tr>
    </table>
</form>
