...
if (sizeof($errors)==0)
{
    ...
    $query_unique_mobile = "SELECT user_id FROM tbl_sys_user WHERE sys_id = $param_session_sys_id AND user_id <> $user_id AND (mobile = '$mobile' OR username = '$mobile') AND registered = 1";
