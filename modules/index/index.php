...
$module_prefix = "Homepage"; //Module Prefix

//Design Page
$design_page = "modules/index/index_des.php";

//Submit Page
$submit_page = "";

//Functions List
$function_list_path = ""; //Path of file which contains the function list ["" if no list]
$function_list_title = ""; //Title of the function box [e.g. "Functions"]
