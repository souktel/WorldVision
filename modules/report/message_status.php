...
$file_name = $apath."modules/report/message_status.php";
...
$module_prefix = "Reports"; //Module Prefix

//Design Page

$design_page = "modules/report/message_status_des.php";

//Submit Page
$submit_page = "";

//Functions List
$function_list_path = "modules/report/message_status_fun.php"; //Path of file which contains the function list ["" if no list]
