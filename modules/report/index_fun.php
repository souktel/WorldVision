...
$fun_menu_count = 0;   
  ...
  * Index 1 = Link
  */
$param_fun_menu[$fun_menu_count][0] = "Message report";
$param_fun_menu[$fun_menu_count][1] = $param_server."/modules/report/index.php";
$param_fun_menu[$fun_menu_count++][2] = $param_abs_path_sib."create_system.png";

$param_fun_menu[$fun_menu_count][0] = "Message Status";
$param_fun_menu[$fun_menu_count][1] = $param_server."/modules/report/message_status.php";
