...
<form name="skform" method="GET" action="message_status.php">
    ...
    <table border="0" width="550" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
        ...
        <tr>
            <td width="3%">&nbsp;</td>
            <td width="48%"><input type="text" value="<?php echo stripslashes($fdate_from);?>" name="date_from" maxlength="10" size="30"><br><font size="2" color="RED">e.g. 2009-03-25</font></td>
            <td width="49%"><input type="text" value="<?php echo stripslashes($fdate_to);?>" name="date_to" maxlength="10" size="30"><br><font size="2" color="RED">e.g. 2009-03-25</font></td>
        </tr>
        <tr>
            <td width="3%">&nbsp;</td>
...
<table border="0" width="680" cellspacing="3" cellpadding="6" style="border-collapse: collapse">
    ...
    <tr>
        ...
        <td width="100"><b><u>Delivery</u></b></td>
    ...
    <?php if($show_results) {
        ...
        while($row = mysql_fetch_array($rs)) {
            ...
            ?>
    <tr style="border-bottom:#999 solid 1px">
        <td width="60" valign="top"><?php echo $rs_prefix;?></td>
        <td width="120" valign="top"><?php echo $rs_sender;?></td>
        <td width="120" valign="top"><?php echo $rs_recipient;?></td>
        <td width="100" valign="top"><?php echo $rs_time_stamp;?></td>
        <td width="100" valign="top"><?php echo printStatus($rs_status);?></td>
        <td width="100" valign="top"><?php echo $rs_status_time==""?"Waiting":$rs_status_time;?></td>
        <td align="left" valign="top" <?php if(!isEnglish($rs_message_text)) {?>dir="rtl"<?php }?>><font face="Trebuchet MS" size="2"><?php echo $rs_message_text;?></font></td>
    </tr>
            <?php }?>
    <tr>
        <td colspan="7"><hr size="0" noshade></td>
