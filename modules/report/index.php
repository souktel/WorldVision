...
$file_name = $apath."modules/report/index.php";
...
$design_page = "modules/report/index_des.php";

//Submit Page
$submit_page = "";

//Functions List
$function_list_path = "modules/report/index_fun.php"; //Path of file which contains the function list ["" if no list]
