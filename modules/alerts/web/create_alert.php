...
//File Name
$file_name = $apath."modules/alerts/web/create_alert.php";
...
$module_prefix = "Alerts"; //Module Prefix

//Design Page
$design_page = "modules/alerts/web/create_alert_des.php";

//Submit Page
$submit_page = "modules/alerts/web/create_alert_sub.php";

//Functions List
$function_list_path = "modules/alerts/web/index_fun.php"; //Path of file which contains the function list ["" if no list]
$function_list_title = "Utilities"; //Title of the function box [e.g. "Functions"]
$function_cur_index = 0; //The index of the function we are in [-1 if no function]
