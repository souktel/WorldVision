...
//File Name
$file_name = $apath."modules/alerts/web/delete_alert.php";
...
//Design Page
$design_page = "modules/alerts/web/delete_alert_des.php";

//Submit Page
$submit_page = "modules/alerts/web/delete_alert_sub.php";
...
$function_cur_index = 4; //The index of the function we are in [-1 if no function]
