...
if (sizeof($errors)==0) {
    ...
    $rs1 = mysql_query("INSERT INTO tbl_alerts_group_members VALUES($group_id, '$mobile', '$name', '$location', '$other_info1', '$other_info2')",$dbid);
    if(!$rs1) {
	...
	$msg_text = "Member information added successfully.";
...
header("Location: editm_group.php?gid=$group_id&msg=".$msg_text);
?>