...
//File Name
$file_name = $apath."modules/groups/web/create_group.php";
...
//Design Page
$design_page = "modules/groups/web/create_group_des.php";

//Submit Page
$submit_page = "modules/groups/web/create_group_sub.php";
