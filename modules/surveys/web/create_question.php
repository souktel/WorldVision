...
//File Name
$file_name = $apath."modules/surveys/web/create_question.php";
...
//Design Page
$design_page = "modules/surveys/web/create_question_des.php";

//Submit Page
$submit_page = "modules/surveys/web/create_question_sub.php";
