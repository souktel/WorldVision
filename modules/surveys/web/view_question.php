...
//File Name
$file_name = $apath."modules/surveys/web/view_question.php";
...
//Design Page
$design_page = "modules/surveys/web/view_question_des.php";
...
$function_cur_index = 11; //The index of the function we are in [-1 if no function]
