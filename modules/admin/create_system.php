...
//File Name
$file_name = $apath."modules/admin/create_system.php";
...
$module_prefix = "Administration"; //Module Prefix

//Design Page
$design_page = "modules/admin/create_system_des.php";

//Submit Page
$submit_page = "modules/admin/create_system_sub.php";

//Functions List
$function_list_path = "modules/admin/index_fun.php"; //Path of file which contains the function list ["" if no list]
